...
class Chart(QtWidgets.QWidget):
    def __init__(self, get_value_func, y_axis_max=None, x_axis_max=60, 
                 title=None, unit='%', refresh_ms=100):
        super().__init__() 
        ...
        self.x_axis.setRange(0, x_axis_max)
        ...
        self.graph_timer.start(refresh_ms)  
        self.time_counter = 0 
